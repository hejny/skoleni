...
{isInitialWelcomeVisible && (
            <div className="fixed inset-0 pt-[72px] flex items-center justify-center z-30 pointer-events-none overflow-y-auto" style={{ paddingBottom: "var(--input-bar-height)" }}>
